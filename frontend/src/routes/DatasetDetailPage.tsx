...
export function DatasetDetailPage(
  ...
  return (
    <div className="detail-page" data-screen="S-05">
      ...
      {/* **못 읽은 것을 「없는 주소」로 말하지 않는다** — 위 묘비 문구는 404 만의 것이다.
          서버가 500 이거나 닿지 않았을 때 그 문구를 쓰면 있는 데이터를 없다고 말한다.
          종전에는 이 자리가 픽스처였고, 픽스처가 모르는 id 는 오히려 묘비로 그려졌다
          (`CODE-REVIEW-20260903` 9). */}
      {detail.status === 'error' ? (
        <LoadFailure
