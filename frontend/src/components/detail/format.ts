 ...
 * ⛔ **안내로만 표시한다** — 저장을 막지 않고 재입력을 강제하지 않는다(PRD-19 「기존 데이터」).
 *    실행 경로는 상세의 `수정` 이고, 그 폼이 두 칸을 갖는다(`editFields.TEXT_FIELDS`).
 */
export const LV0_SOURCE_MISSING_NOTICE =
  'Lv0 인데 출처 주소·내려받은 날이 비어 있어요 — 수정에서 채워 주세요';
