...
/* ── `#24` ㉯ · Ted 판정 ⑧ — 같은 장면(업로드 장면1)의 두 문면.
   **2026-09-12 Ted 확정 · PRD-34/43 개정 〈388〉.** ────────────────────────
...
// 문면 확정 2026-09-12 · PRD-34/43 개정 〈388〉
...
/* ── `#34` 세 번째 선택지 — **2026-09-12 Ted 확정 · PRD-34/43 개정 〈388〉.** ──
   rev2 원문에 대응 문장이 없어 개발 세션이 적었고, 2026-09-12 Ted 확정 · PRD-34/43
   개정 〈388〉 으로 문면이 확정됐다. 자리표 2행 신설 전까지는 PRD-43 표
