...
// ⭑ **⟨20차 해제 · PRD-06 · WU-B7⟩ 아홉 칸 앞에 분류 3축 3행이 섰다** — 열두 칸이다.
// ／ 종전 ~~「아홉 칸」~~ · 정본이 상세에 `분류`·`유형`·`가공 단계` 3행을 요구했다(PRD-06).
// **아홉 칸의 라벨·순서는 한 글자도 안 바뀌었다** — 앞에 셋이 붙었을 뿐이다(회귀).
describe('§5 기본 정보 — 3축 3행 ＋ 아홉 칸', () => {
