 ...
 *   못 고르거나** 그 반대가 되고, **둘 다 조용하다**. `〈357〉` 가 정확히 그 무늬였다.
 *
 ...
 *
 * 근거 = `PLAN-SoT §9 〈55〉`(값 집합은 DB 가 강제한다) · `〈359〉`(4값 → 6값 · 회차 20차).
 */
