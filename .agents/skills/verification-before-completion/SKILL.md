...
description: CoLAB v2 완료 보고 전에 intent와 실제 검증 증거를 대조한다.
---

# Codex 연결

먼저 `AGENTS.md`와 `docs/development/dual-agent.md`를 읽고, `.claude/skills/verification-before-completion/SKILL.md`를 읽어 수행한다.
