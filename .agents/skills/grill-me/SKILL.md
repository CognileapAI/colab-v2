---
name: grill-me
description: CoLAB v2 요구사항을 인터뷰로 검토하고 intent 초안을 작성한다.
---

# Codex 연결

먼저 `AGENTS.md`와 `docs/development/dual-agent.md`를 읽고, `.claude/skills/grill-me/SKILL.md`를 읽어 수행한다.
...
원본의 Skill("grilling")은 `.claude/skills/grilling/SKILL.md`를 직접 읽어 실행한다.
