...
description: CoLAB v2 기능 구현과 버그 수정에서 외부 동작 기준의 실패 테스트부터 검증한다.
---

# Codex 연결

먼저 `AGENTS.md`와 `docs/development/dual-agent.md`를 읽고, `.claude/skills/test-driven-development/SKILL.md`를 읽어 수행한다.
