...
### Ted 판정 결과 (2026-09-24 · 판정 페이지 `reports/design-review/20260924/ted-decisions-eli7.html` 복사본)
...
- 권고와 다른 판정 1건(#5). 보류 0.
- 판정 뒤에도 값이 열린 항목 = #1·#2 전환 값 · #3 임계 · #4 상태 색 · #5 라이브러리 · #7 토큰 이름·값 · #9 `.btn-secondary` hover · #11 토큰 택일 · #12 크기 · #17 토큰 이름·값 → fix spec 에서 제안 후 확정.
- 닫힘 = #6 · #18 · #20(현행 유지) · #10(ⓑ 규칙 확정). #21 = 다음 회차 `routes/**` 재판정 배정.
