...
| V14 | (A6) | agent-bridge · `grep -n 'origin/main' scripts/harness/hooks/decision-number-guard.sh README.md` | ref 부재 fixture 3케이스(Read 0 · 비결정 0 · 결정 번호 2) green · 0건 | C5 이관 |
