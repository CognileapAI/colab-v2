...
- 점수판(완료 정의 ⑥): 3/5/3/3 불변(`2026-09-21-evidence-promotion.md` 점수판 3회차 줄).
  - 정정(2026-09-26 4회차): 3/5/3/3 은 오라클 기록이 dev 의 1회차 승격을 반영하지 못한 숫자였다. dev 실상태로 다시 매긴 점수판은 8/3/3/0 이다(`2026-09-26-cadence-range-predicate.md` 「측정 결과 — 4회차」). 위 ⑥ 의 PC-1-3 · 2-3 「platform 축이 초안」 항목은 1회차 승격으로 이미 풀려 있었다. 「1시간 이하」 범위 술어 deferred 는 같은 4회차에 닫혔다.
