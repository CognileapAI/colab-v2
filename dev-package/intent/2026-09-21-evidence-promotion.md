...
| 4회차 재채점 — dev 실상태(1회차 승격 반영 · `round-4-2026-09-26/` · intent `2026-09-26-cadence-range-predicate.md`) | 8 | 3 | 3 | 0 |
...
- **정정(2026-09-26 4회차)** — 위 표의 「전(dev 현재 · 1회차 승격판)」 3 · 5 · 3 · 3 은 오라클 기록이 dev 보다 한 회차 뒤였던 숫자다. 1회차 승격 3규칙이 dev 에 실린 실상태로 오라클 규칙대로 다시 매기면 8 · 3 · 3 · 0 이다 — blocked_draft 3사례는 full, platform 초안 때문에 partial 로 내렸던 PC-1-3 · 2-3 은 1회차 등급 full 로 돌아온다. 근거·측정은 `dev-package/intent/2026-09-26-cadence-range-predicate.md` 「측정 결과 — 4회차」(PC-1-3 · 2-3 의 되돌림은 Ted 확인 질문 5).
