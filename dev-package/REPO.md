...
```
F:\00_Project\00 CoLAB\30 CoLAB-v2\     ← colab-v2 클론 위치
F:\00_Project\00 CoLAB\20 CoLAB-v1\     ← v1 참조 (동결, 읽기 전용)
```

로컬 폴더 이름과 레포 이름이 달라도 된다. **문서에 절대경로를 적지 않는다** — v1의 HANDOFF가 이 규칙이 없어 실제로 틀렸다.
