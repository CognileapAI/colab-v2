...
> **마지막 실측: 2026-09-03** (전수 재실측 · `PLAN-SoT §9 〈293〉`)
>
...
| E-02 데이터 찾기 | `md-policy` | `Policy_데이터_찾기.md` | 2.0 | ✅ MATCH | `5c7ae828` |
...
| E-07 홈 대시보드 | `md-policy` | `Policy_홈_대시보드.md` | 1.6 | ✅ MATCH | `1c495fd2` |
