...
files 16 · tokens defined 78 · thresholds: font ≥13px · contrast ≥4.5:1 (AA)
...
| `components/catalog/catalog.css` | 13 | 0 | 0 | 18 | 2 | 2 | NO | 1 |
...
| `components/detail/detail.css` | 8 | 0 | 3 | 26 | 0 | 0 | — | 1 |
| `components/lab/lab.css` | 0 | 0 | 1 | 0 | 1 | 0 | — | 0 |
| `components/lineage/lineage.css` | 9 | 0 | 9 | 3 | 2 | 0 | — | 0 |
...
| `shell/shell.css` | 0 | 0 | 0 | 0 | 1 | 7 | NO | 0 |
