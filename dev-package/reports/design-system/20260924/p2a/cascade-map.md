...
생성: `node frontend/scripts/cascade-map.mjs map` · 적재 순서 19파일 · 규칙 1307 · design-system.css 규칙 192. 조사 부록 A(휴리스틱 쌍)를 대체한다.
...
| DS 규칙 | 192 |
| (선택자 인자 × 선언) 단위 | 621 |
| 오늘 어떤 경쟁 규칙에 지는 선언 단위(값 다름) | 40 |
| 되살아남 후보(값 다름) | 348 |
| 그중 상태 선택자(:hover·:focus·[readonly]·[aria-*] 등) | 4 |
| 요소·전체 compound 호환 후보(`type`·`universal` · 표 밖 · 렌더 대조로 확인) | 6909 |
...
| 6 | `.catalog-page .page-head` | 0,2,0 | gap | `8px 12px` | `.project-page .page-head` | components/project/project.css:41 | 0,2,0 | - | `8px` | 순서 | - | 아니오 |
| 6 | `.catalog-page .page-head` | 0,2,0 | gap | `8px 12px` | `.search-page .page-head` | components/search/search.css:23 | 0,2,0 | - | `10px` | 순서 | - | 아니오 |
...
| 6 | `.catalog-page .page-head` | 0,2,0 | margin-bottom | `var(--space-section)` | `.project-page .page-head` | components/project/project.css:42 | 0,2,0 | - | `12px` | 순서 | - | 아니오 |
...
| 7 | `.catalog-page .desc` | 0,2,0 | font-size | `var(--text-body-sm)` | `.project-page .page-head .desc` | components/project/project.css:48 | 0,3,0 | - | `13px` | 필연 | - | 아니오 |
...
| 5 | 6 | - | `.page-head h1` | 0,2,1→0,1,1 | 4 | - | - | pattern:page-head | patterns.css .page-head h1 |
| 5 | 6 | - | `.search-hero h1` | 0,2,1→0,1,1 | 4 | - | - | pattern:page-head | patterns.css .page-head h1 |
| 6 | 7 | - | `.catalog-page .page-head` | 0,3,0→0,2,0 | 2 | - | gap(3) margin-bottom(2) | screen | catalog.css |
| 7 | 8 | - | `.catalog-page .desc` | 0,3,0→0,2,0 | 3 | - | font-size(2) | screen | catalog.css |
...
| 13 | 14 | - | `.catalog-filters select` | 0,2,1→0,1,1 | 3 | - | - | screen | catalog.css |
...
| 16 | 17 | - | `.tbl th` | 0,2,1→0,1,1 | 3 | - | - | primitive:table | primitives.css .table |
| 17 | 18 | - | `.tbl th .thf` | 0,3,1→0,2,1 | 2 | - | padding-inline(1) | screen | catalog.css |
| 18 | 19 | - | `.tbl td` | 0,2,1→0,1,1 | 1 | - | - | primitive:table | primitives.css .table |
...
| 29 | 30 | - | `.colmenu button` | 0,2,1→0,1,1 | 1 | - | - | screen | catalog.css |
...
| 32 | 33 | - | `.search-hero h1` | 0,2,1→0,1,1 | 1 | - | - | screen | search.css |
| 33 | 34 | - | `.search-hero input` | 0,2,1→0,1,1 | 3 | - | - | screen | search.css |
...
| 41 | 42 | - | `.dash-card-head h2` | 0,2,1→0,1,1 | 3 | - | - | screen | dashboard.css |
...
| 49 | 50 | - | `.dash-tile strong` | 0,2,1→0,1,1 | 5 | - | - | screen | dashboard.css |
...
| 52 | 53 | - | `.dash-recent button` | 0,2,1→0,1,1 | 3 | - | - | screen | dashboard.css |
| 53 | 54 | - | `.todo-grp h3` | 0,2,1→0,1,1 | 2 | - | - | screen | dashboard.css |
...
| 56 | 57 | - | `.titem button` | 0,2,1→0,1,1 | 4 | - | - | screen | dashboard.css |
...
| 63 | 64 | - | `.pj-modal-h h3` | 0,2,1→0,1,1 | 3 | - | - | screen | project.css |
...
| 68 | 69 | - | `.pj-row label` | 0,2,1→0,1,1 | 4 | - | - | screen | project.css |
...
| 72 | 73 | - | `.pj-seg button` | 0,2,1→0,1,1 | 4 | - | - | screen | project.css |
...
| 87 | 91 | (max-width: 640px) | `.search-hero h1` | 0,2,1→0,1,1 | 1 | - | - | screen | search.css |
...
| 96 | 100 | (max-width: 640px) | `.pj-seg button` | 0,2,1→0,1,1 | 1 | - | - | screen | project.css |
| 97 | 101 | (max-width: 640px) | `.colmenu button` | 0,2,1→0,1,1 | 1 | - | - | screen | catalog.css |
...
| 112 | 124 | - | `.card-h h3` | 0,2,1→0,1,1 | 3 | - | - | mixed | primitives.css .card + preview.css |
...
| 119 | 131 | - | `.labinfo-modal h3` | 0,2,1→0,1,1 | 2 | - | - | screen | lab.css |
...
| 151 | 172 | - | `.detail-page .dt-header h1` | 0,3,1→0,2,1 | 3 | - | - | screen | detail.css |
| 152 | 173 | - | `.detail-page .dsec-h h2` | 0,3,1→0,2,1 | 1 | - | - | screen | detail.css |
...
| 174 | 199 | - | `.pj-ctl select` | 0,2,1→0,1,1 | 8 | - | - | screen | project.css |
| 175 | 200 | - | `.pj-views` | 0,2,0→0,1,0 | 2 | - | - | screen | project.css |
| 176 | 201 | - | `.pj-views button` | 0,2,1→0,1,1 | 4 | - | - | screen | project.css |
| 177 | 202 | - | `.pj-views button:first-child` | 0,3,1→0,2,1 | 1 | - | - | screen | project.css |
| 178 | 203 | - | `.pj-views button:last-child` | 0,3,1→0,2,1 | 1 | - | - | screen | project.css |
...
| 188 | 216 | (max-width: 640px) | `.pj-ctl select` | 0,2,1→0,1,1 | 2 | - | - | screen | project.css |
