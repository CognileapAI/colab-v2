...
- 기준: `frontend/.visual/p0-s1` · HEAD `f417c769d3f1a26db2a9b27142abc6c4f5574843` · 2026-09-24T01:44:57+00:00
- 후보: `frontend/.visual/p0-s2` · HEAD `f417c769d3f1a26db2a9b27142abc6c4f5574843` · 2026-09-24T02:00:29+00:00
- 명세 sha256: `a5ba330601b8f83b15a164191ded15c6bce5dc9dd17b86f0babe17882df35641`
- 캡처 196장 · 장면 33개 · red 8장 · 엄격 차이 픽셀 합 83 · 보조 차이 픽셀 합 0 · 크기 차이 0장
- 종료코드: **1**

## red 목록

- `project-dialog-light-375` — 엄격 1px · 차이 이미지 `project-dialog-light-375.diff.png`
- `project-dialog-light-768` — 엄격 1px · 차이 이미지 `project-dialog-light-768.diff.png`
- `project-dialog-dark-768` — 엄격 1px · 차이 이미지 `project-dialog-dark-768.diff.png`
- `project-close-dark-768` — 엄격 1px · 차이 이미지 `project-close-dark-768.diff.png`
- `lab-dialog-light-768` — 엄격 17px · 차이 이미지 `lab-dialog-light-768.diff.png`
- `lab-dialog-dark-768` — 엄격 11px · 차이 이미지 `lab-dialog-dark-768.diff.png`
- `search-dark-375` — 엄격 11px · 차이 이미지 `search-dark-375.diff.png`
- `upload-metadata-dark-375` — 엄격 40px · 차이 이미지 `upload-metadata-dark-375.diff.png`

## 불안정 장면

- `project-dialog-light-375` (같은 HEAD 두 번 찍기에서 차이)
- `project-dialog-light-768` (같은 HEAD 두 번 찍기에서 차이)
- `project-dialog-dark-768` (같은 HEAD 두 번 찍기에서 차이)
- `project-close-dark-768` (같은 HEAD 두 번 찍기에서 차이)
- `lab-dialog-light-768` (같은 HEAD 두 번 찍기에서 차이)
- `lab-dialog-dark-768` (같은 HEAD 두 번 찍기에서 차이)
- `search-dark-375` (같은 HEAD 두 번 찍기에서 차이)
- `upload-metadata-dark-375` (같은 HEAD 두 번 찍기에서 차이)
...
| `project-dialog-light-375` | 1 | <0.001 | 0 | 아니오 |
| `project-dialog-light-768` | 1 | <0.001 | 0 | 아니오 |
...
| `project-close-dark-768` | 1 | <0.001 | 0 | 아니오 |
...
| `lab-dialog-light-768` | 17 | 0.002 | 0 | 아니오 |
...
| `search-dark-375` | 11 | 0.003 | 0 | 아니오 |
...
| `upload-metadata-dark-375` | 40 | 0.012 | 0 | 아니오 |
