"""4회차 측정 입력 payload — 새 생성물(질문 2·4 판정 반영)에 1회차 승격(dev 반영 완료) 3규칙을 겹친 사본.

2회차 `round-2-2026-09-26/prepare_input_payload.py` 와 같은 함수·같은 규칙이다. 아래는 그 파일의 설명 그대로다.
...
(`measure_draft_contribution.promote_payload`)로 겹친다. 생성물 자체는 손대지 않는다.
  ...
  services/core-api/.venv/bin/python dev-package/reports/evidence-promotion/round-4-2026-09-26/prepare_input_payload.py
"""
...
NOTE = ("dev-package/intent/2026-09-21-evidence-promotion.md 판정 결과 — 1회차(2026-09-26) · "
        "dev 반영 완료 2026-09-25T23:52Z · 4회차 측정 기준선(dev 와 같은 승격 상태)")
