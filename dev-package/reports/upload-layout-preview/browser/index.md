...
| [contract-expansion](contract-expansion/index.md) | MOD15A2H.A2019273.h27v05.061.2020313082826.hdf | 9731088 | ab7eda26634a5e2f13016acc7e1f8d0cd1daf3924bdbc58538b066b12c12e8a6 | 21 |
...
[계약 확장 최종 실행](contract-expansion/index.md): 대표 그림 저장 실패 뒤 동일 데이터셋 ID 재시도, 파일명 기반 계보 후보 검색, 사람 격자 설명 삭제 뒤 자동값 복귀, 대표 그림 decode·교체·삭제·reload를 실제 브라우저와 격리 DB로 함께 대조했다.
