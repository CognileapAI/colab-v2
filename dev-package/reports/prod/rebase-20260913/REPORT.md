...
- 브랜치 `feature/rtf400_deploy_prod` · 기준 `origin/main` **`aa8bee98`** · 끝 **`c208b052cad8`** · 커밋 **22**.
...
| 2차 | `aa8bee98`(그 사이 7 커밋 전진) | 21 → 22 | **0곳**(1차 해소가 `rerere` 로 재생) |
...
| sha | 무엇 |
|---|---|
| (18 커밋) | 리베이스된 기존 prod 회차 — 내용 무변 |
| `1c68e63a` | **A. prod 반입 도구 결함 정정** |
| `6cd44f78` | **B. prod compose·부트스트랩을 dev 현재판에 맞춤** |
| `6c2e84ad` | **C. 운영 기능 prod 이식** |
| `c208b052` | **D. 결정 번호 재발급 〈383〉 → 〈395〉** |

⚠ A·B·C 의 sha 는 2차 리베이스로 바뀌었다. 끝 sha 는 `c208b052cad8` 이고 `origin/main..HEAD` 는 22 다.
