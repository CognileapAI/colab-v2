...
#
# 기대 행렬(T17 판정 · 14라운드 · 회차 125205·140939·143218·174808·215754):
#   H12 · H15 · H16 — 기록 10실행 전부 통과(정답을 못 알아본 갈래만 보강한 결과).
#   H18 — expect 유지. green 5(125205 r2 · 143218 r2 · 174808 r1 · 215754 r1·r2)
#         · red 3(125205 r1 · 143218 r1 · 174808 r2 — 상태3 이 exit 78 이 아니다)
...
ROUNDS="20260926-125205 20260926-140939 20260926-143218 20260926-174808 20260926-215754"
FAILED=0
OK=0
BAD=0
...
expected() {
  ...
  case "$id" in
    ...
    H18)
      case "$run:$n" in
        20260926-125205:2|20260926-143218:2|20260926-174808:1|20260926-215754:1|20260926-215754:2) echo pass ;;
        20260926-125205:1|20260926-143218:1|20260926-174808:2) echo fail ;;
