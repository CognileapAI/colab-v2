...
from colab_pipeline.kernel import aws_credentials, s3, sigv4
from colab_pipeline.kernel.s3 import S3Client
from colab_pipeline.kernel.sigv4 import EMPTY_SHA256, Credentials, sign_headers

UNIT_PACKAGE = "colab_pipeline"
UNIT_DIR = "services/pipeline-worker"
